...
Template.vcr.events({
  "click #blueTeamCV": function() {
    $('section#aside_rightV').addClass("animated fadeOutRight");
    $('section#aside_leftV').addClass("animated fadeOutLeft");
  },
  "click #redTeamCV": function() {
    $('section#aside_rightV').addClass("animated fadeOutRight");
    $('section#aside_leftV').addClass("animated fadeOutLeft");
  },
  "click #aside_rtV": function() {
    $('section#aside_rightV').removeClass("animated fadeOutRight");
    $('section#aside_leftV').removeClass("animated fadeOutLeft");
    $('section#aside_rightV').addClass("animated fadeInRight");
    $('section#aside_leftV').addClass("animated fadeInLeft");
  },
